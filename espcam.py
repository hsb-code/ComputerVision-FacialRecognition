...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': 'nh-home-security.appspot.com'})
...
url = 'http://192.168.100.122/1600x1200.jpg'
# background image
imbackground = cv2.imread(
    "D:\ML&DL Projects\Home Security System\Resources\c_background.png")  # background image

# importing the mode images into a list
folderModePath = ("D:\ML&DL Projects\Home Security System\Resources\modes")
...
while True:
    ...
    # img = cv2.flip(img, 1)
    imbackground[162:162+480, 55:55+640] = imgS  # rows and column
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                blob = bucket.get_blob(
                    f'D:\ML&DL Projects\Home Security System\Images/{id}.jpg')
